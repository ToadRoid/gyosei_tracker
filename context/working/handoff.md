...
* **latest data merge**: v94 restore (PR #?? 予定、squash merge commit SHA は merge 後確定、次 handoff 編集で補完) / 直前の merged v## = v93 (`075e4a227693f9f6bc13ad1ce3fc502716ae6c20`, PR #51)
...
* **L1 本線**: ✅ 実質完了維持
* **直近 data merge 履歴**: v88 (PR #43, `bd45bd7`) → v89 (PR #44, `2305dad`, A1) → v90 (PR #45, `e2321a9`, A2) → v91 (PR #47, `c9fe732`, A3) → v92 (PR #49, `ece5d89`, A4) → v93 (PR #51, `075e4a2`, A5) → v94 (PR #?? 予定, A6)
...
* **PR #?? / p136-q01 seq2 E restore**（A 群 #6、E text のみ、polarity 非影響、書籍 page 375 右列 row 2 ×）
...
* ~~A6 p136-q01 seq2 E（中盤 structural garble「法律に別段の定めがない限り、直ちに〜原則である）...→不服申立てをしてもよいし、直ちに〜原則であり（8条1項本文: 自由選択主義）」+ 大幅文末欠落「8条1項ただし書: 審査請求前置主義 + 結論」、行訴法8条1項本文 + ただし書 + 結論の 3 段構成復元）~~ → v94 で close（PR #?? 予定）
...
| ~~A6~~ | ~~p136-q01 seq2 E~~ | ~~末尾 `…自由選択主義...` で中断、結論文欠落（+ 中盤 structural garble 「法律に別段の定め/不服申立てをしてもよいし」、8条1項ただし書〜結論の 3 段全欠落）~~ | ~~close（v94, PR #?? 予定）~~ |
