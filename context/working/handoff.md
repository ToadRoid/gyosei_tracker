...
* **latest data merge (in-flight)**: v102 = 本 PR = 後半 L2 バッチ 2 import = **p250 + p251-p270 (excl. p255) = 20 ページ / 104 肢追加**（minpo-bukken / 物権各論）。squash SHA は次 handoff 編集で backfill。
* **前回 data merge**: v101 = PR #71 squash = `77b2c14a8d136436c60226e94a53fce8ca7d08ea`（後半 L2 バッチ 1 = p248 物権変動 5 肢）
* **handoff-only SHA backfill PR**: PR #72（open）= v101 squash SHA backfill、data 無変更
...
* **latest main HEAD at handoff edit time**: `77b2c14a8d136436c60226e94a53fce8ca7d08ea`（PR #71 = v101 merge commit、PR #72 は本 PR と同時に merge 待ち）
* **総ページ**: 240 → **260**（+20 = batch 2 new import）/ **総肢**: 1317 → **1421**（+104）
* **DATA_VERSION**: `2026-04-23-audit-v102-batch2-L2-p250-270-import`（本 PR で v101 → v102 bump）
* **L1 本線**: ✅ 実質完了維持
