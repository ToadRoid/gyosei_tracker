...
* **latest data merge (in-flight)**: v101 = 本 PR = 後半 L2 バッチ 1 import = **p248 物権変動 5 肢追加**。squash SHA は次 handoff 編集で backfill。
...
* **latest main HEAD at handoff edit time**: `ddbeb049c5b03d903f3b97180ad27f659be49de8`（PR #70 merge commit、本 handoff 編集時の repo 先端。v101 merge 後は v101 squash SHA に進む）
