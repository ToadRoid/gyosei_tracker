...
## 現在地（confirmed, 2026-04-25 post-v108-batch8-import + **後半 L2 主レーン稼働 eighth cycle**）

* **latest data merge (in-flight)**: v108 = 本 PR = 後半 L2 バッチ 8 import = **p411-p440 = 28 ページ / 165 肢追加**（shoho-kaisha 99 + kiso-hogaku-gairon 32 + kiso-hogaku-funso 10 + kiso-chishiki-gyomu 24、book 920/921-978/979、**subject 境界 2 つ = p429 shoho→kiso-hogaku + p437 kiso-hogaku→kiso-chishiki**、legit blank 2 ページ = p428/p436 = 基礎法学/業務関連諸法令 主章扉、p437 全 6 肢 chap override = gyosei→kiso-chishiki）。squash SHA は次 handoff 編集で backfill。
* **前回 data merge**: v107 = PR #81 squash = `3513703d0031d02fe5664fe52de150e17ba48e43`（後半 L2 バッチ 7 = p381-p410 = 27 ページ / 172 肢、subject 境界 minpo→shoho、legit blank 3 ページ p386/p387/p399）
...
* **前々々回 data merge**: v105 = PR #78 squash = `2c75251d3d834d0a427af65f28cbb4c1e0abe38f`（後半 L2 バッチ 5 = p322-p350 = 29 ページ / 152 肢、全て minpo-saiken = 契約各論・債権以外の債権発生原因、book 742/743-798/799、章境界なし、0321 = 既存 p320 dup で drop（Claude 起点指示ミス由来）、p328 seq1/2 chap override）
...
* **latest main HEAD at handoff edit time**: `3513703d0031d02fe5664fe52de150e17ba48e43`（PR #81 = v107 merge commit、本 PR = claude/v108-batch8-import）
* **総ページ**: 395 → **423**（+28 = batch 8 new import、legit blank 2 除外）/ **総肢**: 2147 → **2312**（+165）
* **DATA_VERSION**: `2026-04-25-audit-v108-batch8-L2-p411-440-import`（本 PR で v107 → v108 bump）
* **L1 本線**: ✅ 実質完了維持
* **直近 data merge 履歴**: … → v100 (PR #68) → v101-v106 → v107 (PR #81, `3513703`, 後半 L2 batch 7 = p381-p410 = +27 ページ / +172 肢, subject 境界 minpo→shoho, legit blank 3) → v108 (**本 PR**, 後半 L2 batch 8 = p411-p440 = +28 ページ / +165 肢, shoho-kaisha 99 + kiso-hogaku 42 + kiso-chishiki-gyomu 24, **subject 境界 2 つ = p429 shoho→kiso-hogaku + p437 kiso-hogaku→kiso-chishiki**, legit blank 2 ページ p428/p436 = 基礎法学/業務関連諸法令 主章扉, p437 全 6 肢 chap override = gyosei→kiso-chishiki)
